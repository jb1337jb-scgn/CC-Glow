...
void backendWsEvent(WStype_t type, uint8_t* payload, size_t length){
  if(type==WStype_CONNECTED){ backendConnected=true; lastBackendMessage="CONNECTED"; sendBackendEvent("BootNotification"); sendBackendStatusBoth("Available"); }
